...
const Navbar = () => {
    ...
    const toggleDropdown = (dropdownName) => {
        if (dropdownName === "sidebarMenu") {
            setIsOpen("sidebarMenu")
        }
    ...
    return (
        <>
            <nav className="position-relative bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
                    ...
                    <div className={`flex items-center lg:order-2`}>
                        ...
                        <div className="relative inline-block text-left">
                            <button
                                ...
                                onClick={() => toggleDropdown("sidebarMenu")}
                            >
                            ...
                            {/* Dropdown menu */}
                            <div
                                className={`absolute right-0 mt-2 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl ${isOpen === "sidebarMenu" ? "block" : "hidden"
                                    }`}
                                id="dropdown"
                            >
